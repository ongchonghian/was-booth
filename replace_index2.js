...
// I need to replace the entire games.map again to include the "What visitors learn" block.
                    ...
                    React.createElement(
                      ...
                      React.createElement(
                        ...
                        React.createElement(
                          ...
                          React.createElement(
                            "div",
                            { className: "rounded-3xl bg-white/80 border border-slate-200 p-5 shadow-sm" },
                            React.createElement(
                              "div",
                              { className: "text-[10px] uppercase tracking-[0.3em] text-slate-400 font-extrabold mb-4" },
                              "What visitors learn"
                            ),
                            React.createElement(
                              "div",
                              ...
                              game.teaches.map((item) =>
                                React.createElement(
                                  ...
                                  {
                                    key: item,
                                    className: "rounded-lg bg-emerald-50 border border-emerald-100/50 px-3 py-1.5 text-[10px] font-bold text-emerald-700 uppercase tracking-tight"
                                  },
                                  item
                                )
                              )
